      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            download
            className="flex items-center gap-1.5 px-3.5 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-700 rounded-xl text-xs font-semibold shadow-xs transition"
            title="Download complete database JSON snapshot"
          >
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-slate-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h2 className="text-base font-bold text-slate-800">Database Disaster Recovery & Backup</h2>
                      <p className="text-xs text-slate-500 mt-0.5">
                        Download an offline, portable snapshot of all hotel operational records to protect against accidental data loss.
                      </p>
                    </div>
                  </div>
                  <a
                    href="/api/admin/backup"
                    download
                    className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-semibold shadow-sm transition shrink-0"
                  >
                ...
                <div className="mt-5 grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    <p className="text-[11px] font-medium text-slate-500">Rooms in Backup</p>
                    <p className="text-lg font-bold text-slate-800 mt-0.5">{rooms.length} Rooms</p>
                  </div>
                  <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    <p className="text-[11px] font-medium text-slate-500">OTA iCal Feeds</p>
                    <p className="text-lg font-bold text-slate-800 mt-0.5">{configuredIcalCount} Linked</p>
                  </div>
                  <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    <p className="text-[11px] font-medium text-slate-500">Add-on Presets</p>
                    <p className="text-lg font-bold text-slate-800 mt-0.5">{addonPresets.length} Configured</p>
                  </div>
                  <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    <p className="text-[11px] font-medium text-slate-500">Format</p>
                    <p className="text-lg font-bold text-slate-800 mt-0.5">JSON Snapshot</p>
                  </div>
                </div>

                <p className="text-[11px] text-slate-400 mt-4">
                  💡 <strong>Tip:</strong> We recommend downloading a backup weekly or before major room rate or system configuration updates.
                </p>
              </div>

              {/* Security & Threat Protection Status */}
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
                  ...
                  <div>
                    <h2 className="text-base font-bold text-slate-800">Active Security & Protection Safeguards</h2>
                    <p className="text-xs text-slate-500 mt-0.5">Multi-layered security controls active across your system</p>
                  </div>
                </div>
                ...
                <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  <div className="flex items-start gap-3 p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    ...
                    <div>
                      <h4 className="text-xs font-semibold text-slate-800">Role-Based Access Control</h4>
                      <p className="text-[11px] text-slate-500 mt-0.5">Strict separation between Management, Front Desk, and Housekeeping accounts.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    ...
                    <div>
                      <h4 className="text-xs font-semibold text-slate-800">Row Level Security (RLS)</h4>
                      <p className="text-[11px] text-slate-500 mt-0.5">Database tables protected at the database engine level against unauthorized queries.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    ...
                    <div>
                      <h4 className="text-xs font-semibold text-slate-800">15-Minute Inactivity Auto-Logout</h4>
                      <p className="text-[11px] text-slate-500 mt-0.5">Unattended reception desks and terminals automatically lock after 15 minutes of inactivity.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    <ShieldCheck className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-xs font-semibold text-slate-800">Production HTTP Security Headers</h4>
                      <p className="text-[11px] text-slate-500 mt-0.5">HSTS (2-year SSL preload), X-Frame-Options (anti-clickjacking), and MIME protection active.</p>
                    </div>
                  </div>
                </div>
              </div>
